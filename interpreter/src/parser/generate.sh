...
PWD=$( pwd )
LOCATION=$PWD/deps/antlr4-4.5.4-SNAPSHOT.jar
java -jar $LOCATION -Dlanguage=Cpp -listener -visitor -o generated/ -package naylang TLexer.g4 TParser.g4
...
#CLASSPATH=../../../tool/resources/:ST-4.0.8.jar:../../../tool/target/classes:../../../antlr/Java/target/classes:../../../../antlr3/antlr/Java/target/classes
